...
/obj/item/organ/internal/stomach/ethereal/Remove(mob/living/carbon/carbon, special = 0)
	...
	SEND_SIGNAL(src, COMSIG_CLEAR_MOOD_CATEGORY, MOOD_CATEGORY_CHARGE)
...
/obj/item/organ/internal/stomach/ethereal/proc/handle_charge(mob/living/carbon/carbon, delta_time, times_fired)
	switch(crystal_charge)
		if(-INFINITY to ETHEREAL_CHARGE_NONE)
			SEND_SIGNAL(carbon, COMSIG_ADD_MOOD_EVENT, /datum/mood_event/decharged)
		...
		if(ETHEREAL_CHARGE_LOWPOWER to ETHEREAL_CHARGE_NORMAL)
			SEND_SIGNAL(carbon, COMSIG_ADD_MOOD_EVENT, /datum/mood_event/lowpower)
			carbon.throw_alert(ALERT_ETHEREAL_CHARGE, /atom/movable/screen/alert/lowcell/ethereal, 2)
		if(ETHEREAL_CHARGE_ALMOSTFULL to ETHEREAL_CHARGE_FULL)
			SEND_SIGNAL(carbon, COMSIG_ADD_MOOD_EVENT, /datum/mood_event/charged)
		if(ETHEREAL_CHARGE_FULL to ETHEREAL_CHARGE_OVERLOAD)
			SEND_SIGNAL(carbon, COMSIG_ADD_MOOD_EVENT, /datum/mood_event/overcharged)
		...
		if(ETHEREAL_CHARGE_OVERLOAD to ETHEREAL_CHARGE_DANGEROUS)
			SEND_SIGNAL(carbon, COMSIG_ADD_MOOD_EVENT, /datum/mood_event/supercharged)
