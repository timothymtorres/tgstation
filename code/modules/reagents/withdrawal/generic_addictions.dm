...
/datum/addiction/maintenance_drugs/withdrawal_stage_3_process(mob/living/carbon/affected_carbon, delta_time)
	...
	if(lums > 0.5)
		SEND_SIGNAL(affected_human, COMSIG_ADD_MOOD_EVENT, /datum/mood_event/bright_light)
		...
		SEND_SIGNAL(affected_carbon, COMSIG_CLEAR_MOOD_EVENT, /datum/mood_event/bright_light)
