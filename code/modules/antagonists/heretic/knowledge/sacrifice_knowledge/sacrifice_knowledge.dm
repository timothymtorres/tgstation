...
/datum/heretic_knowledge/hunt_and_sacrifice/proc/after_target_wakes(mob/living/carbon/human/sac_target)
	...
	SEND_SIGNAL(sac_target, COMSIG_ADD_MOOD_EVENT,/datum/mood_event/shadow_realm)
...
/datum/heretic_knowledge/hunt_and_sacrifice/proc/return_target(mob/living/carbon/human/sac_target)
	...
	SEND_SIGNAL(sac_target, COMSIG_CLEAR_MOOD_EVENT, /datum/mood_event/shadow_realm)
...
/datum/heretic_knowledge/hunt_and_sacrifice/proc/after_return_live_target(mob/living/carbon/human/sac_target)
	...
	SEND_SIGNAL(sac_target, COMSIG_ADD_MOOD_EVENT, /datum/mood_event/shadow_realm_live)
	SEND_SIGNAL(sac_target, COMSIG_ADD_MOOD_EVENT, /datum/mood_event/shadow_realm_live_sad)
