...
/datum/mutation/human/honorbound/on_acquiring(mob/living/carbon/human/owner)
	if(..())
		return
	//moodlet
	SEND_SIGNAL(owner, COMSIG_ADD_MOOD_EVENT, /datum/mood_event/honorbound)
...
/datum/mutation/human/honorbound/on_losing(mob/living/carbon/human/owner)
	SEND_SIGNAL(owner, COMSIG_CLEAR_MOOD_EVENT, /datum/mood_event/honorbound)
...
/datum/mutation/human/honorbound/proc/punishment(mob/living/carbon/human/user, school)
	switch(school)
		...
		if(SCHOOL_NECROMANCY, SCHOOL_FORBIDDEN)
			...
			lightningbolt(user)
			SEND_SIGNAL(owner, COMSIG_ADD_MOOD_EVENT, /datum/mood_event/banished)
			...
			lightningbolt(user)
			SEND_SIGNAL(owner, COMSIG_ADD_MOOD_EVENT, /datum/mood_event/holy_smite)//permanently lose your moodlet after this
