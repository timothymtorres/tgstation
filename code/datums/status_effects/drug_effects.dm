...
/datum/status_effect/stoned/on_apply()
	...
	SEND_SIGNAL(human_owner, COMSIG_ADD_MOOD_EVENT, /datum/mood_event/stoned) //improves mood
...
/datum/status_effect/stoned/on_remove()
	...
	SEND_SIGNAL(human_owner, COMSIG_CLEAR_MOOD_EVENT, /datum/mood_event/stoned)
