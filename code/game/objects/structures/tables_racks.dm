...
/obj/structure/table/proc/tablepush(mob/living/user, mob/living/pushed_mob)
	...
	SEND_SIGNAL(pushed_mob, COMSIG_ADD_MOOD_EVENT, /datum/mood_event/table)
...
/obj/structure/table/proc/tablelimbsmash(mob/living/user, mob/living/pushed_mob)
	...
	SEND_SIGNAL(pushed_mob, COMSIG_ADD_MOOD_EVENT, /datum/mood_event/table_limbsmash, banged_limb)
